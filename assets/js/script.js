        ...
        switch (url.page) {
            ...
            default:
                loadPage(url.page).then(page => {
                    if (page == 'ranking') displayKlasemen()
                })
                break
        }
    })
...
async function displayTeam(id) {
    ...
    data.squad.forEach((v, i) => {
            squadLeft += `
                    ...
                    <li class="tes collection-item">${v.name}</li>
    ...
    matchdata.matches.forEach(v => {
        match += `
        <li id="card-match" class="collection-item">
        <div class="row">
...
async function displayMatch(id = null) {
    ...
    data.matches.forEach(v => {
        ...
        <div class="col s12 m6 l6">
            <div id="card-match"  class="card horizontal d-flex f-width-100 align-item-center">
